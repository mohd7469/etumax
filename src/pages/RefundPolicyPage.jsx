...
const RefundPolicyPage = () => {
  const { page, loading } = usePolicyPage('refund-policy');
  ...
  return (
    <div className="min-h-screen bg-background pt-12 pb-24">
      <Helmet>
        <title>{page?.title || 'Refund Policy'} - Store</title>
        <meta name="description" content="Learn about our refund, return, and exchange policies." />
      </Helmet>
