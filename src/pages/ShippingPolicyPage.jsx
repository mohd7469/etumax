...
const ShippingPolicyPage = () => {
  const { page, loading } = usePolicyPage('shipping-policy');
  ...
  return (
    <div className="min-h-screen bg-background pt-12 pb-24">
      <Helmet>
        <title>{page?.title || 'Shipping Policy'} - Store</title>
        <meta name="description" content="Details on our shipping rates, processing times, and international delivery." />
      </Helmet>
